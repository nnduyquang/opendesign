...
function archi_theme_scripts_styles() {
    ...
    /** Let it snow **/
    wp_enqueue_style( 'archi-let-it-snow', get_template_directory_uri().'/css/let-it-snow.css');
...
function archi_body_class_names( $classes ) {
    ...
    if($archi_option['topbar-allpage']!=false && $archi_option['header_layout']=="htop_page"){
        $classes[] = 'has-topbar';
    } 
...
function archi_header_class() {
    ...
    if(($archi_option['topbar-onepage']!=false and is_page_template('page-templates/template-onepage.php')) || ($archi_option['topbar-allpage']!=false and !is_page_template('page-templates/template-onepage.php'))){ 
    ...
    if ($archi_option['desktop-sticky']!=true) {
